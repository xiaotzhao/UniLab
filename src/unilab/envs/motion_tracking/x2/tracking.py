...
from unilab.envs.locomotion.agibotx2.base import X2BaseCfg, X2BaseEnv
...
@dataclass
class X2MotionTrackingCfg(X2BaseCfg):
...
@registry.envcfg("X2MotionTracking")
@dataclass
class X2MotionTrackingEnvCfg(X2MotionTrackingCfg):
    """Registered configuration for G1 motion tracking."""

    pass


@registry.envcfg("X2MotionTrackingDeploy")
@dataclass
class X2MotionTrackingDeployEnvCfg(X2MotionTrackingCfg):
...
class X2MotionTrackingDomainRandomizationProvider(DomainRandomizationProvider):
    def __init__(
        self,
        *,
...
@registry.env("X2MotionTracking", sim_backend="mujoco")
@registry.env("X2MotionTracking", sim_backend="motrix")
class X2MotionTrackingEnv(X2BaseEnv):
    """G1 Motion Tracking Environment."""

    _cfg: X2MotionTrackingCfg

    def __init__(self, cfg: X2MotionTrackingCfg, num_envs=1, backend_type="mujoco"):
...
@registry.env("X2MotionTrackingDeploy", sim_backend="mujoco")
@registry.env("X2MotionTrackingDeploy", sim_backend="motrix")
class X2MotionTrackingDeployEnv(G1MotionTrackingEnv):
    """Deploy-oriented G1 motion tracking env with unitree_rl_lab mimic actor inputs."""

    _cfg: X2MotionTrackingDeployEnvCfg
