...
from .tracking import (
    Domain_Rand,
    X2MotionTrackingDomainRandomizationProvider,
    _build_motion_reference_state,
)
from .tracking_sac import X2MotionTrackingSACCfg, X2MotionTrackingSACEnv
...
@dataclass
class X2WBTObsCfg(X2MotionTrackingSACCfg):
...
class X2WBTObsDomainRandomizationProvider(X2MotionTrackingDomainRandomizationProvider):
...
@registry.env("X2WBTObs", sim_backend="mujoco")
@registry.env("X2WBTObs", sim_backend="motrix")
class X2WBTObsEnv(X2MotionTrackingSACEnv):
    ...
    def __init__(self, cfg: X2WBTObsCfg, num_envs: int = 1, backend_type: str = "mujoco"):
        ...
        if needs_extended:
            ...
            extended_provider = X2WBTObsDomainRandomizationProvider(
                base_kp=kp,
                base_kd=kd,
