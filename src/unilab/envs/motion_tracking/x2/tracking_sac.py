...
from .tracking import X2MotionTrackingCfg, X2MotionTrackingEnv


@registry.envcfg("X2MotionTrackingSAC")
@dataclass
class X2MotionTrackingSACCfg(X2MotionTrackingCfg):
    """Config for SAC-based motion tracking (identical fields, separate registry entry)."""


@registry.env("X2MotionTrackingSAC", sim_backend="mujoco")
@registry.env("X2MotionTrackingSAC", sim_backend="motrix")
class X2MotionTrackingSACEnv(X2MotionTrackingEnv):
