...
def main():
    ...
    if not args.play_only:
        ...
        # Build actor
        rl_cfg_dict = dict(rl_cfg) # Use the defined rl_cfg
        
        # Inject dynamic dims into rl_cfg for play mode
        ...
        # APPO Learner get_state_dict() returns {"actor": ..., "critic": ...}
